...
<body style="background-color : #a4b9ce ;">
<div class="container" style="direction:rtl  ; text-align :center ;">
<h2 style="direction:rtl  ; align :right ;">فرم ارزیابی اساتید</h2>
<p style="direction:rtl  ; align :right ;">دانشجوی گرامی لطفا با دقت فرم ارزیابی زیر را تکمیل کنید و در نظر داشته باشید جزِئیات این فرم با هیچ یک از استید در میان گذاشته نخواهد  شد</p><br><br>
    <form action="" method="POST">
		...
		<a href="MasterEvaluation1.php?select=<?= $value->survey_id ;?>">انتخاب استاد بعدی</a>
        </div><br><br><br>
    </form>
</div>
</body>
