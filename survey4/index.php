...
$questions = getAllQuestion4() ;

if (isset($_POST['optradio'])) {
    $survey_faculty_id = $_SESSION['UserId']['user_id'];
    $survey_daneshkadeh_id = rand(1 , 5);
     $i=0 ;
     foreach ($_POST['optradio'] as $question_id =>$survey_mark){
     $sql = "INSERT INTO `survey` (survey_faculty_id , survey_daneshkadeh_id ,survey_question_id, survey_mark)
        VALUES ('$survey_faculty_id','$survey_daneshkadeh_id','$question_id' , '$survey_mark')";
...
<body style="background-color : #ecccd8 ;">
<div class="container" style="direction:rtl  ; text-align :center ;">
<h2 style="direction:rtl  ; align :right ;">فرم ارزیابی هیات علمی</h2>
<p style="direction:rtl  ; align :right ;">مدیر محترم گروه لطفا با دقت به سوالات نظر سنجی پاسخ دهید</p><br><br>
