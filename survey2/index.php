...
$questions = getAllQuestion2() ;
if (isset($_POST['optradio'])) {
    $survey_student_id = $_SESSION['UserId']['user_id'];
	$survey_professor_id = null;
...
<body style="background-color : #bbd6c6 ;">
<div class="container" style="direction:rtl  ; text-align :center ;">
<h2 style="direction:rtl  ; align :right ;">فرم ارزیابی دانشجویان</h2>
<p style="direction:rtl  ; align :right ;">دانشجویان گرامی لطفا نظر خود را نسبت به وضعیت خود در دانشگاه مشخص نمایید </p>
    <form action="" method="POST">
        <table class="table-info" style="width:80% ; margin-right: 9%">
            <thead>
                <tr>
                    <th>شماره</th>
                    <th></th>
