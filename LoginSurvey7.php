...
<head>
    ...
    <title>ورود به صفحه ی نظرسنجی خدمات رفاهی دانشجو</title>
</head>
<body>
<div class="contanier" style="width:40%;background: #fff;padding: 50px;margin: 120px auto;box-shadow: 0 0 3px #ccc;">
    ...
    <form action="" method="post">
        ...
        <br>
        <input type="submit" class="btn btn-success" name="Login7.php" value="ورود به نظرسنجی اساتید">
    </form>
    <?php
    if (isset($_GET['Login7.php'])) {
