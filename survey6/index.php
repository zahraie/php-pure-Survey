...
$questions = getAllQuestion6() ;

if (isset($_POST['optradio'])) {
    $survey_research_id = $_SESSION['UserId']['user_id'];
    $survey_daneshkadeh_id = rand(1 , 5);
     $i=0 ;
     foreach ($_POST['optradio'] as $question_id =>$survey_mark){
     $sql = "INSERT INTO `survey` (survey_research_id , survey_daneshkadeh_id ,survey_question_id, survey_mark)
        VALUES ('$survey_research_id','$survey_daneshkadeh_id','$question_id' , '$survey_mark')";
...
<body style="background-color : #aadcbc ;">
<div class="container" style="direction:rtl  ; text-align :center ;">
<h2 style="direction:rtl  ; align :right ;">فرم ارزیابی گروه پژوهشی</h2>
