...
<?php require_once '../includes/init.php' ; ?>
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deleteSurvey) {
            header('location:surveyManager3.php?success=ok');
        } else {
            header('location:surveyManager3.php?error=ok');
        }
    }
    ?>
    <div class="content"> <!--- start Content --->
        ...
        <table>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey3();
            if ($selectAllSurvey) {
            ...
            <td>
                <a class="delete" href="surveyManager3.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
