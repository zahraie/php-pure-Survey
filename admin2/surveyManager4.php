...
<?php require_once '../includes/init.php' ; ?>
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deleteSurvey) {
            header('location:surveyManager4.php?success=ok');
        } else {
            header('location:surveyManager4.php?error=ok');
        }
    }
    ?>
    <div class="content"> <!--- start Content --->
        ...
        <table>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey4();
            if ($selectAllSurvey) {
                foreach ($selectAllSurvey as $index => $value) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="delete" href="surveyManager4.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
