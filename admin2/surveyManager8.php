...
<?php require_once '../includes/init.php' ; ?>
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deleteSurvey) {
            header('location:surveyManager8.php?success=ok');
        } else {
            header('location:surveyManager8.php?error=ok');
        }
    }
    ?>
    <div class="content"> <!--- start Content --->
        ...
        <table>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey8();
            if ($selectAllSurvey) {
                foreach ($selectAllSurvey as $index => $value) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="delete" href="surveyManager8.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
