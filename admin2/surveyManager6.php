...
<?php require_once '../includes/init.php' ; ?>
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deleteSurvey) {
            header('location:surveyManager6.php?success=ok');
        } else {
            header('location:surveyManager6.php?error=ok');
        }
    }
    ?>
    <div class="content"> <!--- start Content --->
        ...
        <tr>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey6();
            if ($selectAllSurvey) {
                foreach ($selectAllSurvey as $index => $value) {
                    ...
                    <tr>
                        ...
                        ?>
                        <td>
                            <a class="delete" href="surveyManager6.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
