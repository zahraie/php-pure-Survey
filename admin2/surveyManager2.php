...
<div class="body"><!-- start body-->
    ...
    <?php require_once '../includes/init.php' ; ?>
        ...
        if (isset($_GET['delete'])) {
            ...
            if ($deleteSurvey) {
                header('location:surveyManager2.php?success=ok');
            } else {
                header('location:surveyManager2.php?error=ok');
            }
        }
        ?>
    <div class="content"> <!--- start Content --->
        ...
        <table>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey2();
            if ($selectAllSurvey) {
                foreach ($selectAllSurvey as $index => $value) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="delete" href="surveyManager2.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
