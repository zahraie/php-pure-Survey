...
<?php require_once '../includes/init.php' ; ?>
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deleteSurvey) {
            header('location:surveyManager5.php?success=ok');
        } else {
            header('location:surveyManager5.php?error=ok');
        }
    }
    ?>
    <div class="content"> <!--- start Content --->
        ...
        <table>
            ...
            <tbody>
            <?php
            $selectAllSurvey = selectAllSurvey5();
            if ($selectAllSurvey) {
                foreach ($selectAllSurvey as $index => $value) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="delete" href="surveyManager5.php?delete=<?php echo $value['user_id'] ?>">حذف</a>
