...
require_once ('../includes/init.php') ;
    ...
    $role = "SELECT survey_welfare_id ,user_role ,user_fullname ,AVG(survey_mark) as avg FROM `survey`
	inner join `users` on survey.survey_welfare_id = users.user_id
	GROUP BY survey_welfare_id";
...
$graph->ygrid->SetFill(true,'#FFFFFF@0.4','#FFFFFF@0.4');
...
$p1->SetFillGradient('yellow','#effeef');
$p1->SetStepStyle();
$p1->SetColor('#808010');
