...
require_once ('../includes/init.php') ;
    ...
    $role = "SELECT survey_graduate_id ,user_fullname ,AVG(survey_mark) as avg FROM `survey`
	inner join `users` on survey.survey_graduate_id = users.user_id
	GROUP BY survey_graduate_id";
...
$p1->SetFillGradient('green','#558499');
$p1->SetStepStyle();
$p1->SetColor('#808000');
