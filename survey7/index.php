...
$questions = getAllQuestion7() ;

if (isset($_POST['optradio'])) {
    $survey_welfare_id = $_SESSION['UserId']['user_id'];
    $survey_daneshkadeh_id = rand(1 , 5);
     $i=0 ;
     foreach ($_POST['optradio'] as $question_id =>$survey_mark){
     $sql = "INSERT INTO `survey` (survey_welfare_id , survey_daneshkadeh_id ,survey_question_id, survey_mark)
        VALUES ('$survey_welfare_id','$survey_daneshkadeh_id','$question_id' , '$survey_mark')";
...
<body style="background-color : #d4b5b5 ;">
