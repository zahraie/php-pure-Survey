...
$questions = getAllQuestion5() ;

if (isset($_POST['optradio'])) {
    $survey_education_id = $_SESSION['UserId']['user_id'];
    $survey_daneshkadeh_id = rand(1 , 5);
     $i=0 ;
     foreach ($_POST['optradio'] as $question_id =>$survey_mark){
     $sql = "INSERT INTO `survey` (survey_education_id , survey_daneshkadeh_id ,survey_question_id, survey_mark)
        VALUES ('$survey_education_id','$survey_daneshkadeh_id','$question_id' , '$survey_mark')";
...
<h2 style="direction:rtl  ; align :right ;">فرم ارزیابی امور آموزشی</h2>
